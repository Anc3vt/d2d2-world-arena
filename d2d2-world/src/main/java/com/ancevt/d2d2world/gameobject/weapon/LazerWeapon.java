...
public class LazerWeapon extends Weapon {
    ...
    public void shoot(@NotNull World world) {
        //Sound sound = new SoundPool(new FileInputStream("/home/ancevt/workspace/ancevt/d2d2/d2d2-world-arena-server/data/mapkits/character-mapkit/lazer.ogg"));
        //sound.play();
